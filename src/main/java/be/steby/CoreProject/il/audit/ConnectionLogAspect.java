...
//     */
//    @AfterReturning(
//            pointcut = "execution(* be.steby.CoreProject.pl.domains.auth.controller.AuthController.login(..))")
...
//     */
////    @Before("execution(* be.steby.CoreProject.pl.domains.auth.controller.AuthController.logout(..))")
