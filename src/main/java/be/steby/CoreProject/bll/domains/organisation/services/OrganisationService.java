...
public interface OrganisationService {
     ...
     * @throws be.steby.CoreProject.bll.domains.organisation.exceptions.OrganisationNameAlreadyExistsException
     *         if an organisation with the same name already exists
     * @throws be.steby.CoreProject.bll.domains.organisation.exceptions.OrganisationValidationException
     ...
     * @throws be.steby.CoreProject.bll.domains.organisation.exceptions.OrganisationNotFoundException
     *         if either organisation is not found
     * @throws be.steby.CoreProject.bll.domains.organisation.exceptions.OrganisationMergeException
