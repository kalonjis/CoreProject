...
import be.steby.CoreProject.bll.domains.crm.lead.events.LeadAssignedEvent;
import be.steby.CoreProject.bll.domains.crm.lead.events.LeadConvertedEvent;
import be.steby.CoreProject.bll.domains.crm.lead.events.LeadInReviewEvent;
import be.steby.CoreProject.bll.domains.crm.lead.events.LeadRejectedEvent;
import be.steby.CoreProject.bll.domains.crm.lead.exceptions.LeadAlreadyConvertedException;
import be.steby.CoreProject.bll.domains.crm.lead.exceptions.LeadAlreadyRejectedException;
import be.steby.CoreProject.bll.domains.crm.lead.exceptions.LeadNotFoundException;
...
public interface LeadService {
     ...
     * @return the lead
     * @throws LeadNotFoundException if not found
     */
     ...
     * @throws LeadNotFoundException if not found
     * @throws LeadAlreadyConvertedException if terminal
     * @throws LeadAlreadyRejectedException if terminal
     */
     ...
     * Publishes a {@link LeadAssignedEvent}.</p>
     *
     * @param publicId the public UUID of the lead
     ...
     *
     * <p>Publishes a {@link LeadInReviewEvent}.</p>
     *
     * @param publicId the public UUID of the lead
     ...
     * and publishes a {@link LeadConvertedEvent}
     ...
     * @throws LeadAlreadyRejectedException if already rejected
     */
     ...
     * and publishes a {@link LeadRejectedEvent}.</p>
     *
     * @param publicId the public UUID of the lead
