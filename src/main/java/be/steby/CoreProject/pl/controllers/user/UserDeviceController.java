...
//
//    @GetMapping("/current")
//    public ResponseEntity<DeviceInfoResponse> getCurrentDeviceInfo(HttpServletRequest request) {
//        DeviceInfoResponse deviceInfoResponse = DeviceInfoResponse.fromEntity(deviceService.detectCurrentDevice(request)) ;
//        return ResponseEntity.ok(deviceInfoResponse);
//    }
//
//
//    @GetMapping("/my-device/{deviceId}")
//    public ResponseEntity<DeviceInfoResponse> getMyDevice(@PathVariable Long deviceId){
//        DeviceInfoResponse deviceInfoResponse = DeviceInfoResponse.fromEntity(deviceService.getMyDevice(deviceId));
//        return ResponseEntity.ok(deviceInfoResponse);
//    }
//
//
//    @GetMapping("/my-devices-list")
//    public ResponseEntity<List<DeviceInfoResponse>> getDeviceList(HttpServletRequest request) {
//        List<DeviceInfoResponse> deviceInfoResponses = deviceService.getMyDeviceList()
//                .stream()
...
//            @RequestBody DeviceTrustLevelRequest form,
//            HttpServletRequest request) {
